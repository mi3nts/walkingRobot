 ...
 ***************************************************************************/
 ...
 OPCN3NanoMints::OPCN3NanoMints(uint8_t chipSelect){
  alphaSlavePin  = chipSelect;
 }

// Alpha Sensor Functions
 void OPCN3NanoMints::begin()
{
    // printMintsBegin();
...
bool OPCN3NanoMints::initialize(){
  ...
  struct fanDigitalPotShutdownState OPCN3NanoMints::setFanDigitalPotShutdownState(bool status) {
    ...
    struct laserDigitalPotShutdownState OPCN3NanoMints::setLaserDigitalPotShutdownState(bool status) {
      ...
      struct highLowGainState OPCN3NanoMints::setHighLowGainState(bool status) {
...
struct DACandPowerStatus OPCN3NanoMints::readDACandPowerStatus() {
// printMintsBegin();
...
void OPCN3NanoMints::readInformationString() {
// printMintsBegin();
...
void OPCN3NanoMints::readSerialNumber() {
// printMintsBegin();
...
struct firmwareVersion OPCN3NanoMints::readFirmwareVersion() {
// printMintsBegin();
...
void OPCN3NanoMints::readConfigurationVariables() {
// printMintsBegin();
...
struct histogramData OPCN3NanoMints::readHistogramData() {
  // printMintsBegin();
...
return  dataOutput;
 ...
 void OPCN3NanoMints::readPMData() {
  // printMintsBegin();
  Serial.println("Reading Histogram Data ");
  int  size = 14;
  byte inputByte =  0X32;
...
bool OPCN3NanoMints::resetHistogram() {
...
bool OPCN3NanoMints::comparator(byte arrayOne[], byte arrayTwo[], int size)
  {
...
void OPCN3NanoMints::beginTransfer() {

   digitalWrite(alphaSlavePin, LOW);
  delay(1);
   }

void OPCN3NanoMints::endTransfer() {
delay(1);
   digitalWrite(alphaSlavePin, HIGH);
...
// void OPCN3NanoMints::printBytesRead(byte initial[], byte dataIn[], int sizeOfArray)
// {
//     Serial.println("--------------------------------");
...
// void OPCN3NanoMints::printMintsBegin(){
//   // Serial.println("");
//   // Serial.println("--------------------------------");
...
//   void OPCN3NanoMints::printMintsEnd(){
//     // Serial.println("");
//     // Serial.println("-------------MINTS--------------");
//     // Serial.println("--------------------------------");
// }
